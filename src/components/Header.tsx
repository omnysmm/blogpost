...
export default function Header() {
  const { language, currency, currentUser, currentPage, setCurrentPage, setLanguage, logout, toggleSidebar, isSidebarOpen } = useStore();
        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 cursor-pointer" onClick={() => setCurrentPage('home')}>
              ...
              <span className="font-bold text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hidden sm:block">BlogPost</span>
            </div>
          </div>
